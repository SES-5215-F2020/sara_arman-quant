...
```{r}
SCHL_summary <- summary(person_data$SCHL_label)
SCHL_summary
```
...
```{r}
conf_int <- t.test (person_data$SCHL_label == "1 or more years of college credit, no degree")
conf_int
conf_int <- t.test (person_data$SCHL_label == "12th grade - no diploma")
conf_int
conf_int <- t.test (person_data$SCHL_label == "Associate's degree")
conf_int
conf_int <- t.test (person_data$SCHL_label == "Bachelor's degree")
conf_int
conf_int <- t.test (person_data$SCHL_label == "Doctorate degree")
conf_int
conf_int <- t.test (person_data$SCHL_label == "GED or alternative credential")
conf_int
conf_int <- t.test (person_data$SCHL_label == "Grade 1")
conf_int
conf_int <- t.test (person_data$SCHL_label == "Grade 10")
conf_int
conf_int <- t.test (person_data$SCHL_label == "Grade 11")
conf_int
conf_int <- t.test (person_data$SCHL_label == "Grade 2")
conf_int
conf_int <- t.test (person_data$SCHL_label == "Grade 3")
conf_int
conf_int <- t.test (person_data$SCHL_label == "Grade 4")
conf_int
conf_int <- t.test (person_data$SCHL_label == "Grade 5")
conf_int
conf_int <- t.test (person_data$SCHL_label == "Grade 6")
conf_int
conf_int <- t.test (person_data$SCHL_label == "Grade 7")
conf_int
conf_int <- t.test (person_data$SCHL_label == "Grade 8")
conf_int
conf_int <- t.test (person_data$SCHL_label == "Grade 9")
conf_int
conf_int <- t.test (person_data$SCHL_label == "Kindergarten")
conf_int
conf_int <- t.test (person_data$SCHL_label == "Master's degree")
conf_int
conf_int <- t.test (person_data$SCHL_label == "No schooling completed")
conf_int
conf_int <- t.test (person_data$SCHL_label == "Nursery school, preschool")
conf_int
conf_int <- t.test (person_data$SCHL_label == "Professional degree beyond a bachelor's degree")
conf_int
conf_int <- t.test (person_data$SCHL_label == " Regular high school diploma")
conf_int
conf_int <- t.test (person_data$SCHL_label == "Some college, but less than 1 year")
conf_int
```
...
```{r}
CIT_summary <- summary(person_data$CIT_label)
CIT_summary
```
...
```{r}
conf_int <- t.test (person_data$CIT_label == "Born abroad of American parent(s)")
conf_int
conf_int <- t.test (person_data$CIT_label == "Born in Puerto Rico, Guam, the U.S. Virgin Islands, or the Northern Marianas ")
conf_int
conf_int <- t.test (person_data$CIT_label == "Born in the U.S.")
conf_int
conf_int <- t.test (person_data$CIT_label == "Not a citizen of the U.S. ")
conf_int
conf_int <- t.test (person_data$CIT_label == "U.S. citizen by naturalization ")
conf_int
```
